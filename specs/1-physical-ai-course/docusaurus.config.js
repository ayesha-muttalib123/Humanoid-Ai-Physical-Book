    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/your-username/physical-ai-course/tree/main/',
        },
        blog: false, // Disable blog for this educational course
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/your-username/physical-ai-course',
            label: 'GitHub',
            position: 'right',
          },
        ],

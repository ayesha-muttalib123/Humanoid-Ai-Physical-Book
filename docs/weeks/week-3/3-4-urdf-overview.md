---
sidebar_label: URDF Overview (Advanced)
title: URDF Overview - Advanced Robot Modeling Techniques
...
<joint name="bar_1_joint" type="revolute">
...
<!-- Bar 4 connects to bar 2 and bar 3 - closed loop -->
<joint name="bar_4_to_bar_2" type="fixed">
  <parent link="bar_2"/>
  <child link="bar_4"/>
  <origin xyz="0.05 0 0" rpy="0 0 0"/>
</joint>

<joint name="bar_4_to_bar_3" type="fixed">
  <parent link="bar_3"/>
  <child link="bar_4"/>
  <origin xyz="0.05 0 0" rpy="0 0 0"/>
</joint>
...
<transmission name="gear_transmission">
...
<link name="lod_visual_link">
  ...
  <visual name="high_detail">
    <origin xyz="0 0 0" rpy="0 0 0"/>
    <geometry>
      <mesh filename="package://my_robot/meshes/robot_high_detail.dae"/>
    </geometry>
  </visual>
...
```xml
<!-- Different collision representations for different purposes -->
...
<robot xmlns:xacro="http://www.ros.org/wiki/xacro" name="advanced_robot">
  ...
  <!-- Usage example -->
  <xacro:standard_link name="base_link" mass="5.0" length="0.3" width="0.3" height="0.1">
  ...
  <xacro:standard_link name="arm_link" mass="1.0" length="0.2" width="0.05" height="0.05">
    <xacro:origin xyz="0 0 0" rpy="0 0 0"/>
    <xacro:geometry>
...
<robot xmlns:xacro="http://www.ros.org/wiki/xacro" name="humanoid_robot">
  ...
  <link name="torso_link">
    <inertial>
      ...
      <inertia 
        ixx="${3.0*(0.1*0.1 + torso_height*torso_height)/12}" 
        ixy="0" ixz="0"
        iyy="${3.0*(0.2*0.2 + torso_height*torso_height)/12}" 
        iyz="0"
        izz="${3.0*(0.2*0.2 + 0.1*0.1)/12}"/>
    </inertial>
    <visual>
      <origin xyz="0 0 ${torso_height/2}" rpy="0 0 0"/>
      <geometry>
  ...
  <transmission name="left_elbow_yaw_trans">
    <type>transmission_interface/SimpleTransmission</type>
...
<link name="optimized_visual_link">
  ...
  <visual name="high_detail">
    <origin xyz="0 0 0" rpy="0 0 0"/>
    <geometry>
      <mesh filename="package://my_robot/meshes/robot_visual.dae" scale="1 1 1"/>
    </geometry>
  </visual>
  
  <!-- Simplified mesh for collision detection -->
  <collision name="simplified_collision">
    <origin xyz="0 0 0" rpy="0 0 0"/>
    <geometry>
      <mesh filename="package://my_robot/meshes/robot_collision_simple.stl" scale="1 1 1"/>
    </geometry>
  </collision>
</link>
```
...
<joint name="link3_to_link4" type="fixed">
  <parent link="link2"/>
  <child link="link3"/>
  <origin xyz="0.05 0.05 0" rpy="0 0 0.785"/>  <!-- Careful positioning -->
</joint>
```
...
<transmission name="correctly_named_transmission">
  <type>transmission_interface/SimpleTransmission</type>
